((tz) => {
  ...
  const minLuckNum = Math.min(luckNum1, luckNum2, luckNum3, luckNum4, luckNum5)
  ...
  // 调试输出
  console.log(`luckNum1=${luckNum1}, luckNum2=${luckNum2}, luckNum3=${luckNum3}, luckNum4=${luckNum4}, luckNum5=${luckNum5}, minLuckNum=${minLuckNum}, randomRate=${randomRate}, includesMagicNum=${includesMagicNum}`)
